...
class Character(models.Model):
    ...
    great_damage_recovery_days=models.PositiveSmallIntegerField('dias de recuperação de grande dano',default=0)
    great_damage_recovery_day=models.PositiveSmallIntegerField('dia atual da recuperação de grande dano',default=0)
    great_damage_recovery_hp_per_rest=models.PositiveIntegerField('PV por descanso da recuperação de grande dano',default=0)
