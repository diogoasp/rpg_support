...
class Command(BaseCommand):
 def handle(self,*a,**o):
  ...
  Ship.objects.update_or_create(campaign=campaign,name='Brisa do Horizonte',defaults={'category':'medium','description':'Navio fictício da tripulação.','max_hp':120,'current_hp':96,'resistance_class':14,'resistance_bonus':3,'speed':'8 nós','max_crew':20,'current_crew':8,'navigation_resources':'adequate','cannons':4,'facilities':'Cozinha\nEnfermaria\nSala de navegação','is_active':True,'belongs_to_crew':True})
